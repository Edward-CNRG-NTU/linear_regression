...
for day in range(dict_by_type['PM2.5'].shape[0]):
    for hour in range(9, dict_by_type['PM2.5'].shape[1]):
        ...
        xs[counter] = [1,
                       ...
                       *np.power(dict_by_type['AMB_TEMP'][day, hour - 9: hour], 0.5),
                       *np.power(dict_by_type['CH4'][day, hour - 9: hour], 0.5),
                       *np.power(dict_by_type['CO'][day, hour - 9: hour], 0.5),
                       *np.power(dict_by_type['NMHC'][day, hour - 9: hour], 0.5),
                       *np.power(dict_by_type['NO'][day, hour - 9: hour], 0.5),
                       *np.power(dict_by_type['NO2'][day, hour - 9: hour], 0.5),
                       *np.power(dict_by_type['NOx'][day, hour - 9: hour], 0.5),
                       *np.power(dict_by_type['O3'][day, hour - 9: hour], 0.5),
                       *np.power(dict_by_type['PM10'][day, hour - 9: hour], 0.5),
                       *np.power(dict_by_type['PM2.5'][day, hour - 9: hour], 0.5),
                       *np.power(dict_by_type['RAINFALL'][day, hour - 9: hour], 0.5),
                       *np.power(dict_by_type['RH'][day, hour - 9: hour], 0.5),
                       *np.power(dict_by_type['SO2'][day, hour - 9: hour], 0.5),
                       *np.power(dict_by_type['THC'][day, hour - 9: hour], 0.5),
                       *np.power(dict_by_type['WD_HR'][day, hour - 9: hour], 0.5),
                       *np.power(dict_by_type['WIND_DIREC'][day, hour - 9: hour], 0.5),
                       *np.power(dict_by_type['WIND_SPEED'][day, hour - 9: hour], 0.5),
                       *np.power(dict_by_type['WS_HR'][day, hour - 9: hour], 0.5)
                       ]
        counter += 1
